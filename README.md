...
- [DZ-3-nodejs](#dz-3-nodejs)
  ...
  - [API](#api)
    - [Комментарии](#%d0%9a%d0%be%d0%bc%d0%bc%d0%b5%d0%bd%d1%82%d0%b0%d1%80%d0%b8%d0%b8-2)
...
- Выбрал стратегию cache-first. Показалось, что это удобнее:
  - получил логи билда, пошел погулял по приложению, вдруг вспомнил, что не все посмотрел в логах этого билда
  - нажал на карточку этого билда и логи сразу отобразились, они актуальны, потому что в кеш легли сразу из БД
